...
export default function ShopAssortment() {
    ...
    const [shopAssortment, setShopAssortment] = useState([
        ...
        {itemId: 2, name: 'Item 2', price: 123, effect: {'tgChannel': 2}, 
        description: 'Увеличивает приток денег вдвое', image: 'somePicture.png', available: true},

        {itemId: 3, name: 'Item 3', price: 1444, effect: {'tgChannel': 2}, 
        description: 'Увеличивает эффект хаоса вдвое', image: 'somePicture.png', available: true},

        {itemId: 4, name: 'Item 4', price: 15555, effect: {'tgChannel': 2}, 
        description: 'Увеличивает прирост подписчиков вдвое',  image: 'somePicture.png', available: true},

        {itemId: 5, name: 'Item 5', price: 11111, effect: {'tgChannel': 2}, 
        description: 'Увеличивает приток денег вдвое', image: 'somePicture.png', available: true},

        {itemId: 6, name: 'Item 6', price: 12332, effect: {'tgChannel': 2}, 
        description: 'Увеличивает эффект хаоса вдвое', image: 'somePicture.png', available: true},

        {itemId: 7, name: 'Item 7', price: 2332, effect: {'tgChannel': 2}, 
        description: 'Увеличивает прирост подписчиков вдвое',  image: 'somePicture.png', available: true},

        {itemId: 8, name: 'Item 8', price: 3232, effect: {'tgChannel': 2}, 
        description: 'Увеличивает эффект хаоса вдвое', image: 'somePicture.png', available: true},

        {itemId: 9, name: 'Item 9', price: 323232, effect: {'tgChannel': 2}, 
        description: 'Увеличивает прирост подписчиков вдвое',  image: 'somePicture.png', available: true},

        {itemId: 10, name: 'Item 10', price: 232332, effect: {'tgChannel': 2}, 
        description: 'Увеличивает приток денег вдвое', image: 'somePicture.png', available: true},

        {itemId: 11, name: 'Item 11', price: 233232, effect: {'tgChannel': 2, 'money': 2}, 
        description: 'Увеличивает прирост денег и эффект хаоса вдвое', image: 'somePicture.png', available: true},

        {itemId: 12, name: 'Item 12', price: 2323, effect: {'tgChannel': 2}, 
        description: 'Увеличивает прирост подписчиков вдвое',  image: 'somePicture.png', available: true},
    ])
